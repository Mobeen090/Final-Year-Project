...
class _LostItemScreenState extends State<LostItemScreen> {
  ...
  Future<List<Map<String, dynamic>>> _fetchItemsWithIDs() async {
    QuerySnapshot querySnapshot = await FirebaseFirestore.instance.collection('lost items').get();
  ...
  List<Map<String, dynamic>> _searchItems(List<Map<String, dynamic>> items, String query) {
  ...
  Widget _buildListItem(LostFoundItem item, String documentID) {
    return FutureBuilder<DocumentSnapshot>(
      future: FirebaseFirestore.instance.collection('registered users').doc(item.userId).get(),
                        ...
                        Align(
                          ...
                          child: Padding(
                            ...
                            child: RoundedButton(
                              ...
                              onPressed: () {
                                navToItemDetailScreen(context, item, userData, documentID);
                              },
  ...
  void navToItemDetailScreen(BuildContext context, LostFoundItem item, Map<String, dynamic> userData, String documentID) {
    Navigator.pushNamed(context, Routes.itemDetailRoute, arguments: {
      'item': item,
      'userData': userData,
